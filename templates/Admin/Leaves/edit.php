    ...
    <div class="card-body text-body-secondary">
            ...
            <fieldset>
                <legend><?= __('Edit Leave') ?></legend>
                    ...
                    <?php echo $this->Form->control('leave_type_id', ['options' => $leaveTypes, 'empty' => true]); ?>
                    <?php echo $this->Form->control('start_date', ['empty' => true]); ?>
                    <?php echo $this->Form->control('end_date', ['empty' => true]); ?>
                    <?php echo $this->Form->control('reason'); ?>
                    <?php echo $this->Form->control('status'); ?>
                    <?php echo $this->Form->control('applied_on'); ?>
